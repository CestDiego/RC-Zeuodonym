...
/***/ function(module, exports, __webpack_require__) {
	...
	var lelel = function lelel() {
	  senderNameElements = document.getElementsByClassName('sender_name');
	  for (var i = 0; i < senderNameElements.length; i++) {
	    console.log("heh");
	...
	var obs = {};
	var disconnectObs = function disconnectObs() {
	  obs["obs"].disconnect();
	};

	console.log("I'm here!");

	obs["obs"] = new MutationObserver(function (mutations) {
	...
	var sidebarChange = function sidebarChange() {
