...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * unnarrowing streams */
	var filteredElement = document.getElementById('zfilt');
	var filteredSenderNames = filteredElement.getElementsByClassName('sender_name');

	for (var j = 0; j < filteredSenderNames.length; ++j) {
